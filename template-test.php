...
<main id="music" class="display-menu">
    <section class="container">
        ...
        <?php if ( is_page('music') ) { ?>
            <iframe class="col-12" height="250" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?visual=true&#038;url=https%3A%2F%2Fapi.soundcloud.com%2Fusers%2F153893005&#038;show_artwork=true&#038;maxwidth=1260&#038;maxheight=1000&#038;dnt=1">

</iframe>

<div id="streaming" class="col-12 col-md-6 d-flex flex-column align-items-center">
    <h2>Streaming</h2>
    <ul>
        <li>
...
<div id="download" class="col-12 col-md-6 d-flex flex-column align-items-center">
    <h2>Télécharger</h2>
    <ul>
        <li>
