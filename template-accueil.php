...
<main id="accueil" class="display-menu">
    <section class="d-flex flex-column">
        ...
        <div id="content-accueil"> <!-- begining accueil  -->
            <div id="content-actualites">
                <div class="row">
                    <div class="news col-12 col-lg-6 d-flex flex-column align-items-center"> <!-- begining news  -->
                        <a href="news">
                    ...
                    <div class="tour col-12 col-lg-6 d-flex flex-column align-items-center"> <!-- begining tour  -->
                        <a href="tour">
